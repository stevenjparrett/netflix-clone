...
function Banner({ netflixOriginals }: Props) {
    ...
    return (
        <div className='flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12'>
            <div className='absolute top-0 left-o -z-10 h-[95vh] w-screen'>
                <Image
                    layout="fill"
            ...
            <div className='relative pl-4 lg:space-y-6 lg:pl-16'>
                ...
                <div className='flex space-x-3'>
                    <button className='bannerBtn bg-white text-black'><FaPlay className="h-4 w-4 text-black md:h-7 md:w-7"/>Play</button>
